...
/**
 * The type of match by competitive context (issue #108) — open play, league, or tournament, and their
 * playoffs. Different contexts carry different pressure and so are more/less indicative of true skill;
 ...
 * open play); playoffs add further pressure within each.
 *
