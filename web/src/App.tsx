...
const SignUpPage = lazy(() =>
  import("@/routes/SignUpPage").then((m) => ({ default: m.SignUpPage })),
);
...
const CompleteProfilePage = lazy(() =>
  import("@/routes/CompleteProfilePage").then((m) => ({
...
const PlayerProfilePage = lazy(() =>
  import("@/routes/PlayerProfilePage").then((m) => ({
    default: m.PlayerProfilePage,
  })),
);
const PlayerMatchesPage = lazy(() =>
  import("@/routes/PlayerMatchesPage").then((m) => ({
